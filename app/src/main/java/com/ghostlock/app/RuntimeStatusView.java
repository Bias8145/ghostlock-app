...
public class RuntimeStatusView extends LinearLayout {
    ...
    public void refresh() {
        ...
        switch (result.state) {
            case READY:
                ...
                message.setText("Kernel supported and compatible manager detected");
            ...
            case KERNEL_UNSUPPORTED_MANAGER_REQUIRED:
                ...
                message.setText("The kernel is unsupported and no manager is installed");
            ...
            default:
                state.setText("KERNEL UNSUPPORTED");
                state.setTextColor(0xFFFF7777);
                message.setText("This kernel does not provide the required capability");
                setSurface(0xFF2B2022);
                break;
        }
        ...
        manager.setTextColor(result.manager.spoofed ? 0xFFFF7777
                : (result.manager.installed ? 0xFFE0E2E6 : 0xFFFFC94D));
    ...
    private void setSurface(int color) {
        setBackground(round(color, 22));
    }
