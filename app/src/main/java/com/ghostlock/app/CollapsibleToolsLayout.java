...
public class CollapsibleToolsLayout extends LinearLayout {
    ...
    private TextView findFirstTextView(View v) {
        ...
        if (v instanceof ViewGroup) for (int i=0;i<((ViewGroup)v).getChildCount();i++) { TextView f=findFirstTextView(((ViewGroup)v).getChildAt(i)); if(f!=null)return f; }
        return null;
    }
