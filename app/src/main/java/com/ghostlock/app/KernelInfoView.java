...
public class KernelInfoView extends TextView {
    ...
    private CharSequence hiddenText(CharSequence text) {
    ...
    private void setKernelVisible(boolean visible) {
        ...
        super.setText(kernelVisible ? fullText : hiddenText(fullText), BufferType.NORMAL);
        updateEyeIcon();
        setContentDescription(kernelVisible ? "Hide kernel version" : "Show kernel version");
    }
