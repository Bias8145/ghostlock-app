...
public class KsuStatusView extends TextView {
    ...
    public KsuStatusView(Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public KsuStatusView(Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    private void openLink(String url) {
        try {
            ...
            // No browser/activity can handle the URI.
        }
    }
